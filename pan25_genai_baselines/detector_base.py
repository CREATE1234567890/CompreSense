...
class DetectorBase:
    ...
    def get_score(self, text: t.Union[str, t.Iterable[str]], normalize: bool = False) -> \
            t.Union[np.float32, np.ndarray, float]:
        """
    ...
    def predict(self, text: t.Union[str, t.Iterable[str]]) -> t.Union[np.int32, np.ndarray, float]:
        """
    ...
    def predict_with_score(self, text: t.Union[str, t.Iterable[str]], normalize: bool = False) -> t.Tuple[
            t.Union[np.int32, np.ndarray, float],
            t.Union[np.float32, np.ndarray, float]]:
        """
